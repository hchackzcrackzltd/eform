  ...
  <body>
    ...
    <div class="row">
      <div class="col-xs-6">
        ...
        @else
          <img src="{{asset('img/Profile.jpg')}}" class="img-circle col-5" alt="Picture">
        @endif
    ...
    <div class="col-xs-12">
      <p>{{(empty($value->freetm))?'ไม่ระบุ':$value->freetm}}</p>
    </div>
    <div class="col-xs-12">
    ...
    <div class="col-xs-12">
      <p>{{(empty($value->frncm))?'ไม่ระบุ':$value->frncm}}</p>
    </div>
    <div class="col-xs-12">
    ...
    <div class="col-xs-12">
      <p>{{($data->contagious_format)?'มี Yes':'ไม่มี No'}}</p>
    </div>
    @if ($data->contagious_format)
      <div class="col-xs-12">
        <b>มอเตอร์ไซด์ถ้าเคย เป็นอะไร ? (If yes, Please explain ?)</b>
    ...
    <div class="col-xs-12">
      <p>{{($data->law2_format)?'มี Yes':'ไม่มี No'}}</p>
    </div>
