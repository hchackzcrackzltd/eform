...
<div class="form-group">
  ...
  <div class="col-sm-9">
    <label><input type="checkbox" name="hco_status" value="1" form="efm" {{(is_null(old('hco_status')))?($data->job_status==1)?'checked':null:(old('hco_status')==1)?'checked':null}}> :ว่างงาน / Unemployed</label>
  </div>
</div>
<div class="hco_lj">
  <div class="form-group">
    ...
    @php
      $hco_data=$data->getHisJob->where('type',1)->first();
      $his_job=$data->getHisJob->where('type',2);
    @endphp
    <div class="col-sm-9">
      <input class="col-xs-12" type="text" name="hco_name" value="{{(is_null(old('hco_name')))?$hco_data->name:old('hco_name')}}" form="efm" data-inputmask-regex="[A-Za-zก-๙0-9]*" placeholder="Company Name"/>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9" >
      <textarea id="form-field-11" class="autosize-transition form-control" name="hco_address" form="efm" placeholder="Address">{{(is_null(old('hco_address')))?$hco_data->address:old('hco_address')}}</textarea>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9" >
      <div class="input-group">
        <input type="text" class="form-control date-picker" data-date-format="yyyy-mm-dd" form="efm" placeholder="Start date" value="{{(is_null(old('hco_strdate')))?$hco_data->strdate:old('hco_strdate')}}" name="hco_strdate" readonly>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9" >
      <div class="input-group">
        <input type="text" class="form-control date-picker" data-date-format="yyyy-mm-dd" form="efm" value="{{(is_null(old('hco_enddate')))?$hco_data->enddate:old('hco_enddate')}}" placeholder="Until" name="hco_enddate" data-inputmask="'alias': 'yyyy-mm-dd'">
        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
      </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input class="col-xs-12" type="text" name="hco_posit" value="{{(is_null(old('hco_posit')))?$hco_data->posit:old('hco_posit')}}" form="efm" data-inputmask-regex="[A-Za-zก-๙0-9]*" placeholder="Position"/>
    </div>
  </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9" >
          <textarea id="form-field-11" class="form-control" name="hco_respon" form="efm" placeholder="Responsibilities">{{(is_null(old('hco_respon')))?$hco_data->respon:old('hco_respon')}}</textarea>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9" >
          <input class="col-sm-12" type="text" name="hco_ref" value="{{(is_null(old('hco_ref')))?$hco_data->ref:old('hco_ref')}}" form="efm" data-inputmask-regex="[A-Za-zก-๙]*" placeholder="Reference"/>
        </div>
      </div>

  <div class="form-group">
    <div class="col-sm-3"> เกี่ยวข้องเป็น /  Relation </div>
    <div class="col-sm-3"> <input class="col-sm-12" type="text" name="hco_rel" value="{{(is_null(old('hco_rel')))?$hco_data->rel:old('hco_rel')}}" form="efm" data-inputmask-regex="[A-Za-zก-๙]*" placeholder="Relation"/></div>

    <div class="col-sm-2"><center>   โทร /  Tel   </center> </div>
    <div class="col-sm-4"> <input class="col-sm-12" type="text" name="hco_tel" value="{{(is_null(old('hco_tel')))?$hco_data->tel:old('hco_tel')}}" form="efm" data-inputmask-regex="[0-9\-]*" placeholder="Tel"/> </div>
  </div>

  <div class="form-group">
    <div class="col-sm-3"> เหตุผลที่ลาออก /  Reason for leaving </div>
    <div class="col-sm-9">
      <textarea name="hco_resign" class="form-control autosize" rows="5" form="efm" placeholder="Reason for resign">{{(is_null(old('hco_resign')))?$hco_data->resign:old('hco_resign')}}</textarea>
    </div>
  </div>
</div>
      ...
      <div class="widget-box">
        ...
        <div class="widget-body" style="padding:0px 20px 0px 20px;" >
          <div class="widget-main">
            <div class="form-group">
              @forelse ((count(old('his'))>0)?old('his'):$his_job as $key => $value)
                @if ((is_null(old('his')))?($key-1)==0:$key==0)
